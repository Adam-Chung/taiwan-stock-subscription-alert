...
| TASK-009 | Add safe historical-date LINE test mode | verification | primary agent | standard | none | Manual workflow can run a specified date and proxy policy without changing scheduled strict behavior | 2026-07-22 proxy dry run selected 8112; push pending |
