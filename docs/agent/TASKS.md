...
| TASK-013 | Harden MOPS wording and unit parsing; resend 2026-07-15 | verification | primary agent | standard | TASK-012 | Common labels and units parse without selecting partial allocations; strict historical heartbeat is delivered | 25 tests and 2026-07-15 dry run passed; real LINE run pending |
